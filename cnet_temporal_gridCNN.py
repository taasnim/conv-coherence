...
if __name__ == '__main__':
    ...
    parser.set_defaults(
        data_dir        = "./data/"
        ,log_file       = "log"
        ,model_dir      = "./saved_models/18_02/temporal/temporal_gridCNN/19_02_temporal_gridCNN_epoch_"
    ...
    X_train_1, X_train_0, E = data_helper.load_and_numberize_Egrid_with_Feats("data/cnet_2500.train",
            perm_num=opts.p_num, maxlen=opts.maxlen, window_size=opts.w_size, vocab_list=vocab, emb_size=opts.emb_size)

    X_dev_1, X_dev_0, E    = data_helper.load_and_numberize_Egrid_with_Feats("data/cnet_2500.dev",
            perm_num=opts.p_num, maxlen=opts.maxlen, window_size=opts.w_size, E = E, vocab_list=vocab, emb_size=opts.emb_size)

    X_test_1, X_test_0, E    = data_helper.load_and_numberize_Egrid_with_Feats("data/cnet_2500.test",
            perm_num=opts.p_num, maxlen=opts.maxlen, window_size=opts.w_size, E = E, vocab_list=vocab, emb_size=opts.emb_size)
