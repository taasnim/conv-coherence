...
if __name__ == '__main__':
    ...
    parser.set_defaults(
        ...
        data_dir="./data/"
        , log_file="log"
        , model_dir="./saved_models/18_02/pathlevel/pathlevel_pretrained/20_02_pathlevel_pretrained_epoch_"
    ...
    X_train_1, X_train_0, train_f_track, vocab_info_train = cnet_helper.load_data_by_branch_word_entity(
        "data/cnet_2500.train", perm_num=opts.p_num, maxlen=opts.maxlen,
        w_size=w_size, vocabs=vocabs, emb_size=opts.emb_size)

    X_dev_1, X_dev_0, dev_f_track, vocab_info_dev = cnet_helper.load_data_by_branch_word_entity(
        "data/cnet_2500.dev", perm_num=opts.p_num, maxlen=opts.maxlen,
        w_size=w_size, vocabs=vocabs, emb_size=opts.emb_size)

    X_test_1, X_test_0, test_f_track, vocab_info_test = cnet_helper.load_data_by_branch_word_entity(
        "data/cnet_2500.test", perm_num=opts.p_num, maxlen=opts.maxlen,
         w_size=w_size, vocabs=vocabs, emb_size=opts.emb_size)
