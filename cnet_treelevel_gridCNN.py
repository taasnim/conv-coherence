...
if __name__ == '__main__':
    ...
    parser.set_defaults(
        data_dir="./data/"
        , log_file="log"
        , model_dir="./saved_models/18_02/treelevel/treelevel_gridCNN/20_02_treelevel_gridCNN_epoch_"
    ...
    X_train_1, X_train_0, vocab_info_train = cnet_helper.load_data_by_branch_extended(filelist="./data/cnet_2500.train",
                                                                                  maxlen=opts.maxlen, w_size=w_size,
                                                                                  vocabs=vocabs,
                                                                                  maxbranch=opts.max_branch)
    print("Loaded Train Dataset")
    X_dev_1, X_dev_0, vocab_info_dev = cnet_helper.load_data_by_branch_extended(filelist="./data/cnet_2500.dev",
                                                                            maxlen=opts.maxlen, w_size=w_size,
                                                                            vocabs=vocabs, maxbranch=opts.max_branch)
    print("Loaded dev Dataset")
    X_test_1, X_test_0, vocab_info_test = cnet_helper.load_data_by_branch_extended(filelist="./data/cnet_2500.test",
                                                                               maxlen=opts.maxlen, w_size=w_size,
                                                                               vocabs=vocabs,
                                                                               maxbranch=opts.max_branch)
